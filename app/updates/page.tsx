      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="bg-white mb-8">
          <CardContent className="p-6">
            ...
            <p className="text-neutral-700">
              Stay informed about our progress, upcoming features, and how you can get involved in shaping the future of NeuroApp.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-8">
          {updates.map((update, index) => (
            <Card 
              key={index} 
              className={`bg-white border-l-4 ${update.borderColor}`}
            >
              <CardContent className="p-6">
                ...
                {roadmapItems.map((item, index) => (
                  <div key={index}>
                    ...
                    <div className="flex items-center mb-2">
                      <Progress value={item.progress} className="h-2.5 rounded-full bg-neutral-200" />
                      <span className="ml-3 text-sm font-medium text-neutral-700">{item.progress}%</span>
                    </div>
